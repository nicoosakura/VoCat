...
export const EN_DICT: Record<string, string> = {
  ...
  "清空模块旧短信": "Clear modem SMS",
  "清空模块旧短信？": "Clear all modem SMS?",
  "将从模块存储和本地记录中删除该设备全部短信，无法恢复。": "This removes every SMS on this device from modem storage and local records, and cannot be undone.",
  "已清空模块短信": "Modem SMS cleared",
  ...
  "温度": "Temp",
  "模块温度（AT+QTEMP）": "Module temperature (AT+QTEMP)",
